...
class Note_order_dean_api extends Files
{
    ...
    public function __construct()
    {
        ...
        $this->Note_order_dean->col_date = 'note_order_dean_date';
    }
    ...
    public function post()
    {
        ...
        $this->Note_order_dean->col_name_value = $_FILES['note_order_dean']['name'];
        $this->Note_order_dean->col_type_value = $_FILES['note_order_dean']['type'];
        $this->Note_order_dean->col_value = file_get_contents($_FILES['note_order_dean']['tmp_name']);
        $this->Note_order_dean->col_date_value=$_POST['note_order_dean_date'];
